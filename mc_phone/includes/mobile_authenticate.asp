				...
				Else
					...
					Else
						...
						If Not SessionID = "" Then
							...
							Response.Cookies("m").Expires = Now()+1800

							Response.Cookies("p") = txtpassword
							Response.Cookies("p").Path   = "/"
							Response.Cookies("p").Expires = Now()+1800
...
Sub EntitySelect()
	...
	End If
	errortext = "<div class='Font2'>There appears to be a database problem. Please try again later.</div>"
	Retval = -1
	rscounter = 1
	retvalcounter = 1
	...
	'Call StartWMLDocument("Select Company")
	%>
	<table class='Font2' cellpadding="2" cellspacing="0">
	...
	If rsdata1recs Then
		...
		' There is more than just the Maintenance Connection Application they have access to
			...
			FOR resrowcounter= 0 TO resrows
				...
				Else
				%><div class='Font1'><% =rsdata2(6,resrowcounter) %></div>
				<%
				End If
				End If
		...
		Else
			...
			<tr>
			    <td colspan="2" >
			        <font size="3" face="arial" color="white"><b>Please select the company you would like to work with.</b></font>
			    </td>
			</tr>
	...
	%>
			<tr>
			    <td colspan="2">
	                <%
	                If choiceindex > PageSize Then
	                %><b><a href="default.asp?card=entityselect&amp;pagepos=<% =CStr(pagepos-pagesize) %>&amp;s=<% =SessionID %>">Prev</a></b>&nbsp;
	            <%
	            End If
	            If TabIndex = PageSize+1 Then
	            %><b><a href="default.asp?card=entityselect&amp;pagepos=<% =CStr(choiceindex+1) %>&amp;s=<% =SessionID %>">Next</a></b>
	            <%
	            End If
	            %>
			    </td>
			    ...
			    <td colspan="2">
			        <table cellpadding="0" cellspacing="0" height="40">
                        <tr>
                        	<!--
                            <td>
	                            <a href='default.asp?card=entitysearch&s=<% =SessionID %>'><img border="0" src="images/btnSearch.png" /></a>
                            </td>
                            <td width="20">&nbsp;</td>
                            -->
                            <td>
	                            <a href=''default.asp?card=logoff&s=<% =SessionID %>''><img border="0" src="images/btnLogoff.png" /></a>
                            </td>
                        </tr>
                    </table>
			    </td>
					...
					Else
			            ...
			            <tr>
			                <td colspan="2" valign="top">
			                    <img src="images/entIcon.png" alt="" title="" />&nbsp;&nbsp;
			                    <a style="text-decoration:none;" href="default.asp?card=entityselect&amp;ei=<% =CStr(choiceindex) %>&amp;s=<% =SessionID %>"><font size="3" face="arial" color="#ffffff"><b><% =mcval(rsdata3(5,rowcounter)) %></b></font></a>
			                </td>
			            </tr>
...
Sub EntitySearch()
	...
	'Call StartWMLDocument("Company Search")
		%>
		<p align="center" style="font-family:arial; font-size:12pt; color:#ffffff;">
		<b>Company Search</b>
		</p>
		<p align="center">
		<% Select Case searchby
		   Case ""
		%>
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=NONE">ALL</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=EntitySearch&amp;s=<% =SessionID %>&amp;searchby=a">A-F</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=EntitySearch&amp;s=<% =SessionID %>&amp;searchby=g">G-K</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=EntitySearch&amp;s=<% =SessionID %>&amp;searchby=l">L-P</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=EntitySearch&amp;s=<% =SessionID %>&amp;searchby=q">Q-U</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=EntitySearch&amp;s=<% =SessionID %>&amp;searchby=v">V-Z</a>&nbsp;
		<% Case "A" %>
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=NONE">ALL</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=a">A</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=b">B</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=c">C</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=d">D</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=e">E</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=f">F</a>&nbsp;
		<% Case "G" %>
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=g">G</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=h">H</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=i">I</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=j">J</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=k">K</a>&nbsp;
		<% Case "L" %>
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=l">L</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=m">M</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=n">N</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=o">O</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=p">P</a>&nbsp;
		<% Case "Q" %>
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=q">Q</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=r">R</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=s">S</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=t">T</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=u">U</a>&nbsp;
		<% Case "V" %>
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=v">V</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=w">W</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=x">X</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=y">Y</a>&nbsp;
		<a style="font-family:arial; font-size:11pt;text-decoration:none;color:#000000;" href="default.asp?card=authenticate&amp;s=<% =SessionID %>&amp;searchby=z">Z</a>&nbsp;
		<% End Select %>
		</p>
		<%
		HTMLbuttonsBegin
		%>
		<a href="default.asp?card=authenticate&s=<% =SessionID %>&back=1&searchby=NONE"><img src="images/btnBack.png" border="0" /></a>
		<%
		HTMLbuttonsEnd
		SetContext
End Sub
